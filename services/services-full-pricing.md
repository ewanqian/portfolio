...
| 单次讲座 / 分享 | 面向院校、机构、企业分享 | **¥1500–3000 / 场** |
...
| 高斯扫描归档 / 空间采样包 | 适合场地、花园、建筑、作品现场的扫描存档、网页嵌入与展示入口整理 | **¥3000–12000+** |
| Vision Pro / 空间体验原型 | 含内容结构、观看路径、轻量原型与展示入口 | **¥8000–40000+** |
...
这个仓库会持续更新。它既记录已经发生过的作品，也记录一条仍在展开的实践线。我希望它最终成为一个可以被反复进入、阅读和重新组织的个人入口。

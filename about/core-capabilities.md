...
## 5. 双目视频 / XR / Apple Vision Pro / 高斯扫描内容开发

我具备双目 / stereo 影像、数字环境、空间观看和高斯扫描归档方向的开发能力，适合 Apple Vision Pro、XR 展示、双目演出背景、可网页嵌入的 spatial scene 与沉浸式数字环境内容定制。除了影像制作本身，我也会同时考虑平台格式、观看方式、环境风格、网页嵌入、归档组织和内容延展性。如果项目需要继续往前推进到应用层，我也可以承担空间资产整理、体验逻辑梳理、展示原型和与开发协作的需求说明。

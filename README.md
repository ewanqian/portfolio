...
- 想看能力与方法：看 **[Core Capabilities](./about/core-capabilities.md)**
- 想看实践主线、研究入口和工具路线：看 **[Practice Ecosystem](./about/practice-ecosystem.md)**
- 想了解合作服务：看 **[Services Directory](./services/README.md)**、**[Collaboration Overview](./services/collaboration-overview.md)**
...
## Practice Ecosystem / 实践生态

根 `README` 不再继续堆叠实践主线、研究入口、工具路线与公开仓库说明。  
这些高价值信息已经迁移到：
...
如果你希望按“作品主线”和“研究支撑”来理解这套仓库，建议先从 `Practice Ecosystem` 进入。

...
const songSurfaces = [
  {
    ...
    preview: 'Surfaces: PGM long screen, Blender staging view, and floor LED output.',
    previewZh: '屏幕层级：PGM 长屏、Blender 舞台预演与地屏输出。',
    surfaces: [
  ...
  },
  {
    ...
    preview: 'Surfaces: Blender staging view and final PGM output.',
    previewZh: '屏幕层级：Blender 舞台预演与最终 PGM 输出。',
    surfaces: [
  ...
  },
  {
    ...
    preview: 'Surfaces: Blender staging view, final PGM, floor and top-facing outputs.',
    previewZh: '屏幕层级：Blender 舞台预演、最终 PGM、地面与顶面输出。',
    surfaces: [
  ...
  },
  {
    ...
    preview: 'Surfaces: Blender staging view and final floor LED output.',
    previewZh: '屏幕层级：Blender 舞台预演与最终地屏输出。',
    surfaces: [
  ...
  },
  {
    ...
    preview: 'Surfaces: Blender staging view, final PGM, and floor LED output.',
    previewZh: '屏幕层级：Blender 舞台预演、最终 PGM 与地屏输出。',
    surfaces: [
  ...
  },
  {
    ...
    surfaces: [
      ...
      { label: 'Floor LED', labelZh: '地屏', src: '/portfolio/assets/public-optimized/yujiayun-summer-night-floor-1200.webp', ratio: 'square' }
    ]
  }
]
...
const externalRecordings = [
  {
    ...
    titleZh: 'Opening 现场记录 / 上海收官场',
    note: 'The embedded video shows the full opening sequence in its live concert context. Although the Bilibili segment title uses Xia Luo, this page presents it as the concert opening record.',
    noteZh: '这里嵌入视频，是为了观看完整 Opening 在现场中的状态。B站分P写作“下落”，项目页按演唱会 Opening 记录处理。',
  ...
  },
  {
    ...
    titleZh: '宁波站 / 全程跟拍记录',
    note: 'A full-show record for understanding the Ningbo stop and its stage context.',
    noteZh: '用于理解宁波站整体演出语境和舞台状态。',
...
function YuJiayun45m2() {
  ...
  const localizedFacts = isZh
    ? [
      ...
      ['后续记录', '上海收官场 / 2026.04.04 / Opening 现场记录'],
      ...
      <main className="project-page">
        ...
        <section className="section">
          <div className="container">
            <div className="section-heading-row">
              <div>
                <div className="eyebrow">{isZh ? '视频记录' : 'Video Records'}</div>
                <h2 className="section-title">{isZh ? 'Opening 现场视频记录' : 'Opening Video Record'}</h2>
              </div>
              <p className="section-intro">
                {isZh
                  ? '这个视频块只负责看 Opening 在现场的完整状态。曲目画面以最终输出帧整理。'
